...
public class WorldDB extends DBConnection {
	...
	private static GIMHighscoresManager GIMHIGHSCORES = new GIMHighscoresManager();
	...
	public static GIMHighscoresManager getGIMHighscores() {
		return GIMHIGHSCORES;
	}
}
