...
//			player.getInventory().addItem(11694, 1);
			...
			CustomScape.createGodSwordOrLeftShieldOrSigils(player, 11694, 11702, 11690);
			return true;
		}
...
//			player.getInventory().addItem(11696, 1);
			player.sendMessage("You join the hilt and blade into a godsword.");
			CustomScape.createGodSwordOrLeftShieldOrSigils(player, 11696, 11704, 11690);
			return true;
		}
...
//			player.getInventory().addItem(11698, 1);
			player.sendMessage("You join the hilt and blade into a godsword.");
			CustomScape.createGodSwordOrLeftShieldOrSigils(player, 11698, 11706, 11690);
			return true;
...
//			player.getInventory().addItem(11700, 1);
			player.sendMessage("You join the hilt and blade into a godsword.");
			CustomScape.createGodSwordOrLeftShieldOrSigils(player, 11700, 11708, 11690);
			return true;
...
//			player.getInventory().addItem(1187, 1);
			CustomScape.createGodSwordOrLeftShieldOrSigils(player, 1187, 2366, 2368);
			return true;
			...
			if (player.getSkills().getLevel(Constants.PRAYER) >= 85) {
				CustomScape.createGodSwordOrLeftShieldOrSigils(player, 13736, 13734, 13754);
//				player.getInventory().deleteItem(itemUsed, 1);
//				player.getInventory().deleteItem(usedWith, 1);
//				player.getInventory().addItem(13736, 1);
		 ...
		 */
		else if (itemUsed == 13736 && usedWith == 13746 || usedWith == 13736 && itemUsed == 13746) { //b shield, sigil
...
//				player.getInventory().addItem(13738, 1);
				CustomScape.createGodSwordOrLeftShieldOrSigils(player, 13738, 13746, 13736);
...
//				player.getInventory().addItem(13740, 1);
				CustomScape.createGodSwordOrLeftShieldOrSigils(player, 13740, 13748, 13736);
				player.getSkills().addXp(Constants.SMITHING, 1800);
				return true;
			} else {
				player.sendMessage("You need 85 smithing and 90 prayer to attach the sigil.");
...
//				player.getInventory().addItem(13742, 1);
				CustomScape.createGodSwordOrLeftShieldOrSigils(player, 13742, 13750, 13736);
				player.getSkills().addXp(Constants.SMITHING, 1800);
				return true;
			} else {
				player.sendMessage("You need 85 smithing and 90 prayer to attach the sigil.");
...
//				player.getInventory().addItem(13744, 1);
				CustomScape.createGodSwordOrLeftShieldOrSigils(player, 13744, 13752, 13736);
				player.getSkills().addXp(Constants.SMITHING, 1800);
				return true;
			} else {
				player.sendMessage("You need 85 smithing and 90 prayer to attach the sigil.");
		...
		} else if (/*itemUsed == 21369 && usedWith == 4151 || usedWith == 21369 && itemUsed == 4151*/ CustomScape.dontDeleteWhip()) {
