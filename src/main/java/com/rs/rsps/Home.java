...
public class Home {
	...
	public static void spawnNPCs() {
		/* Task master */
		//spawnNPC(14858, Tile.of(3090, 3494, 0), "Cadet Cassandra", Direction.WEST, false);

		/* Scale master */
		spawnNPC(2253, Tile.of(3167, 3491, 0), "Wise Old Man", Direction.EAST, false);

		/* Slayer Masters */
//		spawnNPC(8480, Tile.of(3091, 3487, 0), Direction.SOUTH, false);
//		spawnNPC(8481, Tile.of(3092, 3487, 0), Direction.SOUTH, false);
//		spawnNPC(1597, Tile.of(3093, 3487, 0), Direction.SOUTH, false);
//		spawnNPC(1598, Tile.of(3094, 3487, 0), Direction.SOUTH, false);
//		spawnNPC(7779, Tile.of(3095, 3487, 0), Direction.SOUTH, false);
//		spawnNPC(8466, Tile.of(3096, 3487, 0), Direction.SOUTH, false);
		spawnNPC(9085, Tile.of(3165, 3489, 0), "Master Slayer", Direction.SOUTH, false);
		spawnNPC(15661, Tile.of(3166, 3486, 0), Direction.WEST, false);
		spawnNPC(15147, Tile.of(3164, 3489, 0), "Slayer Assistant", Direction.SOUTH, false);//Slayer teleport

		/* GIM */
		spawnNPC(1512, Tile.of(3165, 3482, 0), "GIM Tutor", Direction.SOUTH, false);
	...
	private static Teleport[] PVP_TELEPORTS = {
			new Teleport("Mage bank (SAFE)", Tile.of(2539, 4715, 0)),
			new Teleport("Wests (level 10)", Tile.of(2976, 3597, 0), p -> p.getControllerManager().startController(new WildernessController())),
			new Teleport("Chaos altar (level 12)", Tile.of(3229, 3609, 0), p -> p.getControllerManager().startController(new WildernessController())),
			new Teleport("Dark warrior's fortress (level 15)", Tile.of(3007, 3632, 0), p -> p.getControllerManager().startController(new WildernessController())),

			new Teleport("Revenant caves (level 18)", Tile.of(3082, 10058, 0), p -> p.getControllerManager().startController(new WildernessController())),
			new Teleport("Easts (level 19)", Tile.of(3350, 3667, 0), p -> p.getControllerManager().startController(new WildernessController())),
			new Teleport("West Lava Maze/KBD (level 40)", Tile.of(3028, 3839, 0), p -> p.getControllerManager().startController(new WildernessController())),
			new Teleport("Red Dragon Isle (level 43)", Tile.of(3202, 3860, 0), p -> p.getControllerManager().startController(new WildernessController())),

			new Teleport("Agility course (level 49)", Tile.of(2997, 3909, 0), p -> p.getControllerManager().startController(new WildernessController())),
			null,
			null,
			null
	};

	public static ObjectClickHandler healingWell = new ObjectClickHandler(new Object[] { 28715 }, Tile.of(3172, 3466, 0), e -> {
	...
	public static ObjectClickHandler pvpPortal = new ObjectClickHandler(new Object[] { 46935 }, Tile.of(3093, 3506, 0), e -> {
	...
	public static ObjectClickHandler bossPortal = new ObjectClickHandler(new Object[] { 46933 }, Tile.of(3083, 3492, 0), e -> {
	...
	public static ObjectClickHandler slayerPortal = new ObjectClickHandler(new Object[] { 46934 }, Tile.of(3095, 3483, 0), e -> {
